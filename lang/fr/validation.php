...
return [
    ...
    */
    ...
    'doesnt_contain' => 'Le champ :attribute ne doit pas contenir d\'éléments parmi les suivants : :values.',
    ...
    | personnalisée pour un attribut et une règle donnés.
    |
    */
    ...
    | comme "Adresse électronique" au lieu de "email". Cela contribue
    | simplement à rendre nos messages plus expressifs.
    |
    */
