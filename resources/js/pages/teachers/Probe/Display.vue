...
<template>
    ...
    <AppLayout>
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b pb-6">
                <div>
                    <h2 class="text-3xl font-extrabold text-gray-900 tracking-tight">Sondage en cours</h2>
                    <p class="text-gray-500 mt-1">Diffusez les informations ci-dessous à vos élèves.</p>
                </div>
                <div class="flex items-center gap-3 bg-green-50 border border-green-200 px-4 py-2 rounded-full">
                    <span class="text-green-700 font-semibold uppercase text-sm">Live : {{ timer }}</span>
                </div>
            </div>
            ...
            <div class="mt-10">
                ...
                <div class="mt-10 gap-10 grid grid-cols-2">
                    <div class="bg-blue-600 p-6 rounded-xl shadow-lg text-white">
                        <label class="text-xs font-bold text-blue-200 uppercase">Code d'accès</label>
                        <p class="text-5xl font-mono font-black mt-2 text-center">
                            {{ session?.code }}
                        </p>
                    </div>
                    ...
                    <div class="bg-gray-800 p-6 rounded-xl shadow-lg text-white">
                        ...
                        <p class="text-5xl font-mono font-bold mt-2 text-center text-blue-400">
                            {{ session?.password }}
                        </p>
                    </div>
                </div>
